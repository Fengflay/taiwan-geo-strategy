# Taiwan GEO Strategy (台灣 GEO 完整行銷方案)

> Generative Engine Optimization — 讓 AI 主動推薦你的品牌

## What is GEO?

GEO (Generative Engine Optimization) is the practice of optimizing your brand's visibility in AI-powered search engines (ChatGPT, Google Gemini, Perplexity, Claude, etc.) so that AI actively recommends your brand when users ask relevant questions.
...
- **Growth Engine**: Free AI visibility checker tool design, viral loop, partnership models
- **90-Day Roadmap**: Week-by-week action items with KPIs
- **Compliance**: Taiwan Fair Trade Act, Consumer Protection Act, Personal Data Protection Act

## Target Audience

- Taiwan B2B enterprises (SMEs primarily)
- Marketing managers and digital transformation leads
- Business owners looking to improve AI search visibility

## Created By

Multi-expert analysis combining insights from:
- SEO/GEO Strategy Specialist
- Content Marketing Expert
- Social Media & Brand Strategist
- Frontend Technical Implementation Expert
